# This is a small augmentation of AllenNLP code 
# https://github.com/allenai/allennlp/blob/master/allennlp/models/biaffine_dependency_parser.py
# Only activation functions were changed to Leaky RELU with slope=0.1
...
@Model.register("biaffine_parser_a")
class BiaffineDependencyParser_a(Model):
    """
    ...
    def __init__(self,
        ...
        super(BiaffineDependencyParser_a, self).__init__(vocab, regularizer)
        ...
        self.head_arc_feedforward = arc_feedforward or \
                                        FeedForward(encoder_dim, 1,
                                                    ...
                                                    Activation.by_name("leaky_relu")(negative_slope=0.1))
